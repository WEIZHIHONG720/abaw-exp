...
if __name__ == '__main__':
    ...
    # 1.2. Paths
    # parser.add_argument('-dataset_path', default='/home/data/wyq/ABAW_VA/ABAW2-test/ABAW2-EXP/exp_dataset_test/Affwild2_processed', type=str,
    #                     help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob
    parser.add_argument('-dataset_path', default='/home/data/wyq/ABAW_VA/ABAW2-test/ABAW2-EXP/data_all/Affwild2_processed/', type=str,
                        help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob 
    parser.add_argument('-model_load_path', default='/home/data/czp/code/ABAW2-test/ABAW2-EXP', type=str,
                        help='The path to load the trained model, such as the backbone.')  # /scratch/users/ntu/su012/pretrained_model
    parser.add_argument('-model_save_path', default='/home/data/czp/code/ABAW2-test/ABAW2-EXP/save', type=str,
                        help='The path to save the trained model ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='/home/data/czp/code/ABAW2-test/ABAW2-EXP', type=str,
    ...
    parser.add_argument('-experiment_name', default="ABAW2-exp-newmodel-win300-stride399-fold0-bs16_newval", help='The experiment name.')
